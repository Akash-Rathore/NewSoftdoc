...
public class IndexingUploading {
	 ...
	 private static Storage storage = null;
	  ...
	  public String uploadDocument(Part filePart, final String bucketName,String timeDate) throws IOException {
		   
		   
		    final String filespace = filePart.getSubmittedFileName();
		    String file_name= timeDate+"_"+filespace;
		    String fileName = file_name.replaceAll("\\s", ""); 
		    //The InputStream is closed by default, so we don't need to close it here
		    //Read InputStream into a ByteArrayOutputStream.
		    InputStream is = filePart.getInputStream();
		    ByteArrayOutputStream os = new ByteArrayOutputStream();
