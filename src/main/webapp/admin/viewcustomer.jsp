                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           ...
                           <form class="form-horizontal" action="Process?action=customerupdate&id=<%=id%>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z0-9]{0,60}" class="form-control" id="NameSurname" name="customernum" placeholder="Customer Number" value="<%=resultset.getString("customer_number")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z\s]{0,60}"  class="form-control" id="companyname" name="companyname" placeholder="Company Name" value="<%=resultset.getString("company_name")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z0-9]{0,60}" class="form-control" id="compan" name="compan" placeholder="Company PAN" value="<%=resultset.getString("company_pan")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="type" id="type" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="industry" id="industry" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text"  pattern="[A-Za-z0-9._%+-\s]{0,60}" class="form-control" id="billingaddressone" name="billingaddressone" placeholder="Billing Address Line 1" value="<%=resultset.getString("billing_address_first")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z0-9._%+-\s]{0,60}" class="form-control" id="Email" name="billingaddresstwo" placeholder="Billing Address Line 2" value="<%=resultset.getString("billing_address_sec")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z\s]{0,60}" class="form-control" id="Email" name="billingstate" placeholder="Billing Address State" value="<%=resultset.getString("state")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                        maxlength = "6" class="form-control" id="Email" name="billingpincode" placeholder="Billing Address PinCode" value="<%=resultset.getString("pincode")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z\s]{0,60}" class="form-control" id="Email" name="compername" placeholder="Contact Person Name" value="<%=resultset.getString("company_per_name")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="text" pattern="[A-Za-z\s]{0,60}" class="form-control" id="Email" name="comperdesignation" placeholder="Designation" value="<%=resultset.getString("company_per_designation")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="number" class="form-control" id="mobile" name="mobile" placeholder="Mobile" value="<%=resultset.getLong("mobile")%>" readonly>
                                        </div>
                                    </div>
                                </div>
                               ...
                               <div class="row"><center><strong><h5>Service Information</h5></strong></center></div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                             <input type="text" class="form-control"  name="storageData" id="storageData" placeholder="Storage Data In GB" value="<%=resultset.getInt("storagedata")/1000%>" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <select class="form-control" name="quality" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            ...
                                            <select class="form-control show-tick" name="color" disabled>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="filegst" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="filepan" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="filetan" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="filesigned" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="filequestion" disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="file" class="form-control" name="fileother" disabled="disabled">
