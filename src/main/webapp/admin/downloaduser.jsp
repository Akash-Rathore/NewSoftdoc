                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <%
                                      try(Connection  connection=StoreDBConnection.openConnection(); PreparedStatement  preparedStatement=connection.prepareStatement("SELECT * FROM `softdoc_staff` where `role`!='superadmin' and role!='admin' ORDER BY id DESC");)
                                        {
                              ...
                              %>
                                 ...
                                 <tr>
                                        ...
                                        <%if(resultset.getString("joining_date").equals("01 Jan 0001")){%> 
                                            <td></td>
                                          <%}else{%>
