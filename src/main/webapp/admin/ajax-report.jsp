...
<body>
                                ...
                                <%
                                                          	try(Connection  connection=StoreDBConnection.openConnection(); PreparedStatement preparedStatement=connection.prepareStatement("SELECT `loginid`, `ip`, `logintime`, `action` FROM `logfile` where role!='superadmin'and role!='client' and role!='admin' and `logintime` BETWEEN '"+request.getParameter("start")+"' and '"+request.getParameter("end")+"' ORDER BY id DESC");)
                                                                                                  { 
