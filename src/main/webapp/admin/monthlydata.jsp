                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                 <%
                                                 ...
                                                 String count="";
                                                 try(Connection  connect=StoreDBConnection.openConnection();PreparedStatement preparedStatement=connect.prepareStatement("SELECT  approved_date , file_no , department , SUM(ROUND(size,2))AS size , status FROM document_info WHERE billing_month ='"+currentdate+"' and company_id='"+request.getParameter("id")+"' and status='quality_approved' GROUP BY file_no");
                                                     )
                                                  {
                                                          ...
                                                          while(resultset.next())
                                                          {
                                                             ...
                                                             {
                                                                 ResultSet result=stat.executeQuery("SELECT COUNT(DISTINCT document_no)as count FROM document_info WHERE file_no='"+resultset.getString("file_no")+"' and status='quality_approved'");
                                                                 if(result.next())
                                                                 {
