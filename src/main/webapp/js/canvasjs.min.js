...
v&&(l.setAttribute("state",v),l.setAttribute("type","button"),pa(k,l,{ display:"none" , padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),l.setAttribute("title",k._cultureInfo[v+"Text"]),l.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[v].image+"' alt='"+k._cultureInfo[v+"Text"]+"' />")}function La(){for(var k=null,l=0;l<arguments.length;l++)k=arguments[l],k.style&&(k.style.display="inline")}function ua(){for(var k=
