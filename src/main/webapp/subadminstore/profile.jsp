                    ...
                    <div class="card">
                       ...
                       <%
                       	try(Connection connection=StoreDBConnection.openConnection();
                       			PreparedStatement  preparedStatement=connection.prepareStatement("SELECT `password` , `name`, `designation`, `mobile`, `email`, `location` FROM `softdoc_staff` WHERE id='"+(int) session.getAttribute("store_id")+"'");
                                )
                        {
                       ...
                       %>     <div class="body mrgnbtm">
                              <form  method="post" id="profile" class="form-horizontal">
  ...
  <script src="include/custom-script.js"></script> 
    <script type="text/javascript">
      $('#profile').submit(function(e){
	     e.preventDefault();
	    	      ...
	    	      console.log(data);
	      $.ajax({
	    	       url:"../storeprocess?action=storeupdateprofile",
	    	       type:"POST",
	    	       dataType:"json",
	    	       data:data,
                   beforeSend:function(){
   ...
   //=============//==========================   
      $(document).on('submit', '.form-submit', function (e) {
         ...
         var form=$(this);
           ...
           //===============//================
           $.ajax({
      	       url:"../storeprocess?action=storechangepassword",
      	       type:"POST",
      	       dataType:"json",
      	       data:data,
      	       beforeSend:function(){
   ...
   //========================//=================
     ...
     $.ajax({
            ...
            url:"../storeprocess?action=uploadphoto",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
