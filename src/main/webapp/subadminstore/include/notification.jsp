                            ...
                            <li class="header">NOTIFICATIONS</li>
                              ...
                              <%
                                                          	try(  Connection  connect=StoreDBConnection.openConnection();
                                                          			 PreparedStatement preparedStatement=connect.prepareStatement("SELECT `logintime`, `action` FROM `logfile` where user_id='"+(int) session.getAttribute("store_id")+"' and role='"+(String)session.getAttribute("storerole")+"' ORDER BY id DESC LIMIT 5");
                                                                    )
                                                            {
