                            ...
                            <li class="header">NOTIFICATIONS</li>
                              ...
                              <%
                                          try( Connection  connect=QualityDBConnection.openConnection();
                                        		  PreparedStatement preparedStatement=connect.prepareStatement("SELECT `logintime`, `action` FROM `logfile`  where user_id='"+(int) session.getAttribute("quality_id")+"' and role='"+(String)session.getAttribute("qualityrole")+"' ORDER BY id DESC LIMIT 5");
                                                   )
                                           {
