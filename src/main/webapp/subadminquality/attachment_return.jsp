...
<body class="theme-light-blue">
                        ...
                        <div class="body mrgnbtm">
                                      <%
                                            ...
                                            String document_no="";
                                         	...
                                         	try(Connection connect=QualityDBConnection.openConnection();PreparedStatement preparedStat=connect.prepareStatement("SELECT * FROM document_info, customer_details WHERE document_info.company_id = customer_details.id AND document_info.id ='"+request.getParameter("id")+"' and status='return_quality'");)
                                            {
                          ...
                          <%if(resultset.getString("department").equals("Hr")){ %>  
                                ...
                                <div class="form-group">
                                    <label for="NameSurname" class="col-sm-2 control-label">Remark</label>
                                    <div class="col-sm-10">
                                      <div class="form-line">
                                        <select class="form-control" name="documenttype" readonly>
                                        	<option value="<%=resultset.getString("remark")%>"><%=resultset.getString("remark")%></option>
                                        </select>
                                      </div>  
                                    </div>
                                </div>
                       ...
                       <!--==================================================end of Hr==================================  -->
                        ...
                        <div class="form-group">
                          <div class="col-sm-12 table-responsive">
                             <table class="table table-hover" id="myTable">
                                ...
                                <tbody>
                                <%
                                      try(Connection  connect=QualityDBConnection.openConnection(); PreparedStatement preparedStatement=connect.prepareStatement("SELECT * FROM `document_info` WHERE document_no = '"+document_no+"' and file_no='"+file_no+"' and status='return_quality'");)
                                      {
                        ...
                        <div class="container-fluid">
                           ...
                           <form class="form-submit">
                              <div class="row"> 
                                 <div class="form-group">
                                     <label for="NameSurname" class="col-sm-5 control-label"> Q1. Are all available indexing fields filled?  (yes/no)</label>
                                     <div class="col-sm-3">
                                        <div class="form-line">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="NameSurname" class="col-sm-5 control-label"> Q3. Is the attachment correct? (yes/no) </label>
                                    <div class="col-sm-3">
                                        <div class="form-line">
  ...
  function myFunction(remark_value) {
			     ...
			     $.ajax({
		    	       ...
		    	       success:function(data,textStatus,jqXHR)
		    	       {
		     	    	  ...
		     	    	  if(data.status)
		    	          {
			 	    	   ...
			 	    	   var  doc = res[1];
		                   setTimeout(function(){
			     	    		 window.location.href="document_single3.jsp?id="+doc;
			     	       })
