                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <tbody id="txtHint">
                                       <%
                                       	try(Connection  connection=QualityDBConnection.openConnection();PreparedStatement preparedStatement=connection.prepareStatement("SELECT * FROM `logfile` where user_id='"+(int) session.getAttribute("quality_id")+"' and role='"+(String)session.getAttribute("qualityrole")+"' ORDER BY logintime DESC");)
                                        {
                        ...
                        <div class="body">
                            <div class="table-responsive">
                              ...
                              <%
                                            ...
                                            try(Connection  connect=QualityDBConnection.openConnection();PreparedStatement preparedStatement=connect.prepareStatement("SELECT SUM(size) AS size, file_no, company_name , department, upload_date FROM customer_details, document_info WHERE document_info.company_id = customer_details.id AND document_info.history_quality='history_quality'  AND document_no IS NOT NULL GROUP BY document_info.file_no");)
                                             {
                                                 ResultSet resultset=preparedStatement.executeQuery();
                                                 while(resultset.next())
                                                 {
                               %>      
                                        <tr>
                                           <td><a href="historydocument.jsp?id=<%=resultset.getString("file_no")%>"><%=resultset.getString("file_no")%></a></td>
