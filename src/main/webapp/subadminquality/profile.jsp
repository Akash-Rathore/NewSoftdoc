            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                       ...
                       <%
                                          try(Connection connection=QualityDBConnection.openConnection();
                                        		  PreparedStatement  preparedStatement=connection.prepareStatement("SELECT `username`, `password`, `name`, `designation`, `mobile`, `email`, `location` FROM `softdoc_staff` WHERE `id`='"+(int) session.getAttribute("quality_id")+"'");
                                                  )
                                            {
                       ...
                       %>     <div class="body mrgnbtm">
                              <form action="" method="post" id="profile" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        ...
                                                        maxlength = "10"	class="form-control" id="mobile" name="mobile" placeholder="Mobile" value="<%=resultset.getString("mobile")%>" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script type="text/javascript">
      $('#profile').submit(function(e){
	     e.preventDefault();
	    	      ...
	    	      console.log(data);
	      $.ajax({
	    	       url:"../qualityprocess?action=qualityupdateprofile",
	    	       type:"POST",
	    	       dataType:"json",
	    	       data:data,
                   beforeSend:function(){
  ...
  //===============//==============
	    $(document).on('submit', '.form-submit', function (e) {
         ...
         var form=$(this);
           ...
           //===============//================
           $.ajax({
      	       url:"../qualityprocess?action=qualitychangepassword",
      	       type:"POST",
      	       dataType:"json",
      	       data:data,
      	       beforeSend:function(){
 ...
 //========================//=================
	$(document).on('submit', '.form-upload', function (e) {
     ...
     $.ajax({
            ...
            url:"../qualityprocess?action=uploadphoto",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
