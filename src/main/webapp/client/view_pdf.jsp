      ...
      <span class="page-info">
        Page <span id="page-num"></span> of <span id="page-count"></span>
                            ...
                            <%
                                       ...
                                       try(Connection  connect=DBConnection.openConnection(); PreparedStatement preparedStatement=connect.prepareStatement("SELECT file FROM `document_info` WHERE id ='"+request.getParameter("url")+"'");)
                                      {
                            ...
                            %>
                                               ...
                                               <input type="hidden" id="url" value="<%=resultset.getString("file")%>">
