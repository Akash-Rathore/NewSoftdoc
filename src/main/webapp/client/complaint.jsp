    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">CUSTOMER CLIENT</a>
            </div>
       ...
       <div class="col-xs-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body mrgnbtm">
                         <form action="../clientprocess?action=clientcomplainlist" method="post" id="fileUploadForm">
   ...
   $('#btnSubmit').click(function(e){
          ...
          var data = new FormData(form);
           $.ajax({
	            ...
	            url:'../clientprocess?action=clientcomplainlist',
	            data: data,
	            processData: false,
	            contentType: false,
	            cache: false,
