...
<!-- <link href="../css/custom-style-index.css" rel="stylesheet">
 --><style type="text/css">
	...
	<%--    <%@include file="include/message.jsp"%>
	     ...
	     <div class="container-fluid" style="height: 38px; background: #6c757d;">
	          ...
	          <div style="position:relative;padding-left:242px;">
                  <input type="text" name="" id="input_css" value="" style="display:none;height: 27px;font-size: 15px;position:inherit ; top:0px ;width: 400px !important; border: 2px solid #6c757d; border-radius: 25px;padding-left:10px; " placeholder="Search in Softdoc Cloud" />
                  <a href="search.jsp"  style="font-size: 16px;padding-left:130px;position:inherit;top:0px;color:#fff;">Advanced Search</a>
...
<!--              <a href="#"  style="text-decoration:none;color:#fff;padding-left:309px;"><span style="font-size:32px;font-weight:bold;">+</span></a>
 ...
 -->	          
	...
	<%@include file="include/script.jsp"%>
	 <script src="include/chosen.jquery.js"></script>
	...
	<script type="text/javascript">
 	...
 	function client_chat_details(){
	  ...
	  $.ajax({
	        ...
	        url: "../clientprocess?action=client_chat_details",
	        type: "post",
	        dataType:"json",
  ...
  setInterval(function(){
   ...
   $(document).on('click' , '.chat-group' , function(){
	      ...
	      $.ajax({
		        ...
		        url: "../clientprocess?action=clients",
		        type: "post",
		        dataType:"json",
		        success: function(data)
		        {
		        	...
		        	var html_data ="<select multiple style='width:220px;height:32px;font-size:16px;' class='sel'>";
		        	$.each(obj,  function( key, value ) {
		        		 html_data +='<option value="'+value.id+'">'+value.name+'</option>'
		        	})
		              html_data +='</select>'
		        	
		        	$('.video_cam').html(html_data);
		        	$('.sel').chosen();
	...
	$(document).on('click' , '.send_btn' , function(){
		 ...
		 if($('.sel').val()){
		  ...
		  $.ajax({
		        ...
		        url: "../clientprocess?action=client_message",
		   ...
		   success:function(data,textStatus,jqXHR)
 		   {
			    ...
			    var obj = JSON.parse(data.name);
			    console.log(obj,'client_name------>')
			    
 			    var name_data="";
 			    $.each(obj,  function( key, value ) {
 			    
 			    	name_data +='<a href="javascript:void(0);" class="client_chat_details" style="text-decoration:none;" data-id='+value.id+' data-role='+value.role+'>'
