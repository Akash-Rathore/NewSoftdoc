                    ...
                    <div class="card">
                       ...
                       %>
                            ...
                            <div class="table-responsive">
                             ...
                             <%
            	                            try(Connection  connect=DBConnection.openConnection();PreparedStatement preparedStatement=connect.prepareStatement("SELECT id ,count(attachment_no)as count,hit,document_no,department,document_type,upload_date FROM `document_info` WHERE file_no =(select file_no from document_info where id='"+request.getParameter("id")+"') and document_no != 'null' group by document_no");)
                                            {
                                                  ResultSet resultset=preparedStatement.executeQuery();
