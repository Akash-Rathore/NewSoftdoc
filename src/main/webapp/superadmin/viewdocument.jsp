                        ...
                        <div class="body">
                            <div class="row">
                             <%
                                    ...
                                    String file_no="";
                                    try(Connection  connect=DBConnection.openConnection();PreparedStatement preparedStatement=connect.prepareStatement("SELECT count(attachment_no)as count,customer_name,customer_code,invoice_date,date_of_joining,employee_code,employee_name,invoice_number,vendor_name,vendor_code,document_type,document_no,sum(size) as size, file_no, company_name, department, upload_date , documentType1 , documentType2 , documentType3 , documentType4 , documentType5 , documentType6 FROM customer_details, document_info WHERE document_info.company_id = customer_details.id AND document_no =(select document_no from document_info where id='"+request.getParameter("id")+"') AND file_no =(select file_no from document_info where id='"+request.getParameter("id")+"')  GROUP BY document_info.file_no");)
                                    {
                             ...
                             %>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                          ...
                                          <input type='hidden' value="<%=resultset.getString("document_no")%>" name="document_no" class="form-control show-tick">
                                    </div>
                                </div>
                                <div class="form-group">
                               ...
                               <div class="form-group">
                                    <label for="NameSurname" class="col-sm-2 control-label">Attachment Counter:-</label>
                                    <div class="col-sm-10">
                                            <input type='text' value="<%=resultset.getString("count")%>" name="companyname" class="form-control show-tick" readonly="readonly">
                                    </div>
                                </div>
                              </div>  
                          <div class="row">
