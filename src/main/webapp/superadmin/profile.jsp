            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                       ...
                       <%
                            try(Connection  connection=DBConnection.openConnection();PreparedStatement  preparedStatement=connection.prepareStatement("SELECT `username`, `password`, `name`, `designation`, `mobile`, `email`, `location` FROM `softdoc_staff` WHERE `id`='"+(int) session.getAttribute("super_id")+"'");)
                           {
                       ...
                       %>     <div class="body mrgnbtm">
                              <form  id="profile" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-line">
                                                        <input type="password" class="form-control" STYLE="color: #696D6D; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #EAFDFD;" id="password" name="password" placeholder="**" value="<%=resultset.getString("password")%>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <div class="form-line">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action='../superpassword'   method='post' class='form-submit'>
          <div class="form-group">
    ...
    <script type="text/javascript">
      $('#profile').submit(function(e){
	     e.preventDefault();
	    	      ...
	    	      console.log(data);
	      $.ajax({
	    	       url:"../superprocess?action=superupdateprofile",
	    	       type:"POST",
	    	       dataType:"json",
	    	       data:data,
                   beforeSend:function(){
 ...
 //================//===========================================
   $(document).on('submit', '.form-submit', function (e) {
    e.preventDefault();
     ...
     //===============//================
     $.ajax({
	       url:"../superprocess?action=superpassword",
	       type:"POST",
	       dataType:"json",
	       data:data,
	       beforeSend:function(){
...
//==========================//=====================
	$(document).on('submit', '.form-upload', function (e) {
     ...
     $.ajax({
            ...
            url:"../superprocess?action=uploadphoto",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
