            ...
            <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                       ...
                       <%
                       	try(Connection connection=IndexingDBConnection.openConnection(); PreparedStatement  preparedStatement=connection.prepareStatement("SELECT `username`, `password`, `name`, `designation`, `mobile`, `email`, `location` FROM `softdoc_staff` WHERE `id`='"+(int)session.getAttribute("index_id")+"'");)
                        {
                       ...
                       %>     <div class="body mrgnbtm">
                              <form action="../indexingprocess?action=indexingupdateprofile" method="post" id="profile" class="form-horizontal">
    ...
    <script type="text/javascript">
      $('#profile').submit(function(e){
	     e.preventDefault();
	    	      ...
	    	      console.log(data);
	      $.ajax({
	    	       url:"../indexingprocess?action=indexingupdateprofile",
	    	       type:"POST",
	    	       dataType:"json",
	    	       data:data,
                   beforeSend:function(){
 ...
 //=====================//=========================
	   $(document).on('submit', '.form-submit', function (e) {
         ...
         var form=$(this);
           ...
           //===============//================
           $.ajax({
      	       url:"../indexingprocess?action=indexchangepassword",
      	       type:"POST",
      	       dataType:"json",
      	       data:data,
      	       beforeSend:function(){
 ...
 //=============================
	   $(document).on('submit', '.form-upload', function (e) {
		     ...
		     $.ajax({
		            ...
		            url:"../indexingprocess?action=uploadphoto",
		            data: data,
		            processData: false,
		            contentType: false,
		            cache: false,
